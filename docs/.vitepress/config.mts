    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '08. 좋은 조사 결과가 자동으로 좋은 블로그가 되지 않는 이유', link: '/build-journey/08-why-good-research-does-not-automatically-become-a-good-blog' },
          { text: '09. 에르메스는 단순 챗봇이 아니라 운영 시스템이다', link: '/build-journey/09-hermes-is-an-operating-system-not-just-a-chatbot' },
          { text: '10. 에르메스에서 스킬은 언제 만들고 어떻게 관리해야 할까', link: '/build-journey/10-when-and-how-to-manage-skills-in-hermes' },
          { text: '11. Obsidian LLM Wiki를 실제 운영에 어떻게 활용할 것인가', link: '/build-journey/11-how-to-use-obsidian-llm-wiki-in-real-operations' },
          { text: '12. always-on gateway는 왜 생각보다 자주 헷갈릴까', link: '/build-journey/12-always-on-gateway-is-more-confusing-than-it-looks' },
          { text: '13. 과거 유산은 지워야 할까 남겨야 할까', link: '/build-journey/13-what-to-do-with-legacy-while-keeping-current-truth-clear' },
          { text: '14. 에르메스 운영에서 제일 자주 나오는 질문들', link: '/build-journey/14-most-common-hermes-ops-questions-and-how-to-think' },
          { text: '15. 멀티봇 스레드는 왜 쉽게 시끄러워질까', link: '/build-journey/15-why-multibot-threads-get-noisy' },
          { text: '16. 조사형 에이전트는 왜 자주 결론을 서두를까', link: '/build-journey/16-why-research-agents-rush-to-conclusions' },
          { text: '17. 정리형 에이전트는 왜 그럴듯하지만 약한 글을 만들까', link: '/build-journey/17-why-writing-agents-produce-polished-but-weak-drafts' },
          { text: '18. 하비가 언제 직접 처리하고 언제 위임해야 할까', link: '/build-journey/18-when-harvey-should-handle-directly-vs-delegate' },
          { text: '19. 방울이와 뽀동이는 왜 각각 다른 실패를 반복할까', link: '/build-journey/19-why-bangwooli-and-ppodongi-fail-differently' },
          { text: '20. 복구 플레이북은 왜 문서보다 순서가 중요할까', link: '/build-journey/20-why-recovery-playbooks-are-about-order-not-just-docs' },
          ...
          { text: '27. 처음 에이전트를 도입한 조직은 왜 운영에서 자주 무너질까', link: '/build-journey/27-why-agent-adoption-fails-in-operations' },
        ],
      },
      {
        text: '개발자 가이드',
